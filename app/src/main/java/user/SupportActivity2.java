...
public class SupportActivity2 extends Activity {
    //widget
...
//		});
        ...
        Support.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(SupportActivity2.this, HowtoActivity.class);
        ...
        WebMail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent = new Intent(SupportActivity2.this, MovieActivity.class);
                    startActivity(intent);
                    finish();
