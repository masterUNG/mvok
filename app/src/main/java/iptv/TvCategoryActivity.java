    ...
    public class CheckAccessTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (!this.check.booleanValue()) {
                Intent intent = new Intent((Context)TvCategoryActivity.this, (Class)ErrorActivity.class);
                TvCategoryActivity.this.startActivity(intent);
                Toast.makeText((Context)TvCategoryActivity.this.getApplicationContext(), (CharSequence)"text5 Internet text6", (int)1).show();
                return;
            }
            {
                ...
                try {
                    ...
                    } else if (playerInstalledOrNot("com.mxtech.videoplayer.2pro")) {
                        //////added  by  tony
                        Intent intent = new Intent();
                        ComponentName comp = new ComponentName("com.mxtech.videoplayer.pro", "com.mxtech.videoplayer.ActivityScreen");
        ...
        public class installgold extends AsyncTask<String, Void, Void> {
            ...
            protected Void doInBackground(String... arg0) {
                try {
                    ...
                    String link = "http://nofix.me/mx/" + nameapp;
