...
public class IpTvData {
	...
	public ArrayList<IpTvData> getMain(){
		String resultData = portalServices.makePortalCall(null, UrlApp.MAIN_TV2, PortalServices.GET);
		try {
	...
	public ArrayList<IpTvData> getCategory(String main_id){
		String resultData = portalServices.makePortalCall(null, UrlApp.CATEGORY_TV2+"?main_id="+main_id, PortalServices.GET);
		try {
			String decrypted = new String(mcrypt.decrypt(resultData));
			JSONObject jsonObject = new JSONObject(decrypted);
			JSONArray jArrData = jsonObject.getJSONArray("data");
	...
	public ArrayList<IpTvData> getList(String id){
		String resultData = portalServices.makePortalCall(null, UrlApp.CATEGORY_TV2+"?id="+id, PortalServices.GET);
		try {
			String decrypted = new String(mcrypt.decrypt(resultData));
			JSONObject jsonObject = new JSONObject(decrypted);
			JSONArray jArrData = jsonObject.getJSONArray("data");
